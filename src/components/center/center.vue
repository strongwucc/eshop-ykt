  ...
  <div class="center-page" ref="centerPage">
    ...
    <div class="mian-list">
      <ul>
        ...
        <li @click="$router.push('/my_order/dine')">
          <div class="l">
        ...
        <li>
          <div class="l">
            <img class="icon" src="../../assets/img/center/member_icon_add@2x.png">
    ...
    <div class="features">
      ...
      <ul class="list" v-show="featuresViewVisible">
        <li v-if="deskInfo && storeInfo" @click="$router.push({name: 'store', params: {storeId: storeInfo.store_id, deskId: deskInfo.desk_id, people: deskInfo.people}})">点餐首页</li>
        ...
        <li v-if="deskInfo && deskInfo.status === '2' && deskInfo.info.status === 'active'" @click="$router.push({name: 'confirm_pay', params: {deskId: deskInfo.desk_id}})">结账</li>
      </ul>
    </div>
    <mt-popup
