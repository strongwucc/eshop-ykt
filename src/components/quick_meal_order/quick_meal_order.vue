<template>
  <div class="my-order-page">
    <div class="dine-page">
        ...
        <scroll class="scroll-wrapper" :data="orderList" :bounce="bounce" :pullup="!allLoaded" @scrollToEnd="getDineList">
          <div class="scroll-content">
            <div class="order-item" v-for="orderItem in orderList">
              <div class="top">
                <span class="table">
                  <template v-if="orderItem.promotion_type === 'normal'">
                    订单号：{{orderItem.order_id}}
                  </template>
                </span>
                ...
                <span class="pay-status will-agree" v-else-if="orderItem.promotion_type == 'normal' && orderItem.pay_status == '1' && orderItem.confirm_status == '0'" >
                  待商家接单
                </span>
              ...
              <div class="center" v-if="orderItem.promotion_type === 'normal'" @click="$router.push('/order_detail/quick_meal_detail/'+orderItem.order_id)">
                <ul class="pic-list">
              ...
              <div class="bottom">
                ...
                <div class="other-features" >
                  ...
                  <button class="go-detail" v-if="orderItem.promotion_type === 'normal' && orderItem.pay_status != '0' && orderItem.pay_status != '3'" @click="$router.push('/order_detail/quick_meal_detail/'+orderItem.order_id)">
                    <!--<img src="../../assets/img/"/>-->
                    查看详情
                  </button>
        ...
        <back :url="'/quick_meal_center'"></back>
      </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      setStyle () {
        ...
        document.querySelector('.scroll-wrapper').style.height = window.innerHeight - orderStatus.offsetHeight + 'px'
      },
